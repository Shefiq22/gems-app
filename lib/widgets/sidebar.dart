// ============================================================
//  GEMS — Sidebar (role-aware, live sign-out)
//  Admin   → all 9 nav items
//  Officer → Dashboard, Faculties, Tasks, Reports, Guide,
//             Issues, Vegetation Reports, Alerts, Settings
//  Groundskeeper → Dashboard, My Tasks, Submit Report,
//                  Alerts, Green Guide, Settings
//  Student → Dashboard, Issues (report), Green Guide
// ============================================================
...
class _NavDef {
  final IconData icon;
  final String   label;
  final int      index; // used by DashboardScreen to switch body
...
class _GEMSSidebarState extends State<GEMSSidebar> {
  ...
  static const _adminNav = [
    ...
    _NavDef(Icons.notifications_rounded,    'Alerts',             8),
  ...
  Widget build(BuildContext context) {
    ...
    return AnimatedContainer(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(color: Colors.black.withOpacity(0.25), blurRadius: 20),
        ],
      ),
      child: Column(
        children: [
              ...
              child: Container(
                ...
                child: Row(
                  children: [
                    CircleAvatar(
                      radius: 18,
                      backgroundColor: GEMSTheme.accentGreen.withOpacity(0.8),
      ...
      child: GestureDetector(
        ...
        child: AnimatedContainer(
          ...
          padding: EdgeInsets.symmetric(
            horizontal: widget.collapsed ? 12 : 14, vertical: 11),
          decoration: BoxDecoration(
